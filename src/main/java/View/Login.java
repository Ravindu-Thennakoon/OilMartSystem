...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        this.setExtendedState(Login.MAXIMIZED_BOTH); // Maximize window
    ...
    private void initComponents() {
        ...
        jLabel5.setFont(new java.awt.Font("Baskerville Old Face", 0, 48)); // NOI18N
        jLabel5.setText("Oil Mart");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean verify = controller.checkLogin(position,username, password);
       ...
       if(verify){
        ...
        JOptionPane.showMessageDialog(this, "Invalid Credentionals");
    }
